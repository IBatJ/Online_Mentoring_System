  ...
  <section id="container">
         ...
         <li class="sub-menu">
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
              ...
              <li class="active"><a href="view_previous_mentoring.php">Previous Mentoring Form</a></li>
            </ul>
          </li>
          <li class="sub">
    ...
    <select class="form-control" name="semester" style="width: 210px;margin-left: 800px;margin-top: -30px;">
                ...
                <?php
                      ...
                      $id = $ro['SID'];
                      $sem = $ro['SEMESTER'];
                      $query = "SELECT * FROM previous_mentoring_details WHERE SID='$id' AND SEMESTER < '$sem'";
                      $results = mysqli_query($db, $query);
                      $n = mysqli_num_rows($results);
  ...
  display:block;width: 150px;height: 40px;" name="submit">Submit</button>
    <?php
      ...
      if(isset($_POST['submit']))
      {
        ...
        $re = $run->fetch_assoc();
        $dq = "SELECT * FROM student WHERE SID='$id'";
        $res = mysqli_query($db, $dq);
        $r = $res->fetch_assoc();
    ?>
    </form>
          ...
          <div class="col-lg-12">
            <div class="form-panel" style="width: 75%;margin: auto;">
              ...
              <form class="form-horizontal style-form" method="post">
                ...
                <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label" style="font-size: 17px;">Name</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" required name="fname" value="<?php echo $r['SNAME']?>" disabled>
                  </div>
                </div>
                <div class="form-group">
